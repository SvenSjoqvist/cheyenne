...
export async function generateMetadata(): Promise<Metadata> {
  ...
  return {
    ...
    description:
      "Kilaeko is committed to web accessibility for all users. Learn about our WCAG 2.1 AA compliance, accessibility features, and how to report accessibility issues.",
    keywords: [
...
export default async function Accessibility() {
  ...
  const structuredData = (await generateStructuredData("/accessibility")) || {
    ...
    description:
      "Kilaeko accessibility policy and WCAG 2.1 AA compliance information",
    url: "https://kilaeko.com/accessibility",
    mainEntity: {
      "@type": "Article",
      headline: "Accessibility Policy - Kilaeko",
      description:
        "Kilaeko is committed to ensuring that our website is accessible to all users, including those with disabilities.",
      author: {
        "@type": "Organization",
        name: "Kilaeko",
      ...
      <div className="bg-[#F7F7F7] pt-20 pb-32">
        ...
        <div className="max-w-3xl mx-auto px-6 mt-12">
          <p className="font-darker-grotesque text-lg mb-8">
            TWO DNA LLC (&ldquo;Kilaeko&rdquo;) is committed to ensuring that
            our website is accessible to all users, including those with
            disabilities. We strive to comply with the Web Content Accessibility
            Guidelines (WCAG) 2.1 level AA, which is an internationally
            recognized standard for web accessibility.
          </p>
          ...
          <p className="font-darker-grotesque text-lg mb-8">
            ...
            constantly working to improve the user experience for all visitors.
            As new technologies and best practices emerge, we will update our
            site accordingly.
          </p>
          ...
          <p className="font-darker-grotesque text-lg mb-8">
            Despite our best efforts, if you encounter any accessibility
            barriers while using our site, please let us know. You can contact
            us at accessibility@kilaeko.com with a description of the issue you
            faced and the specific page or feature where it occurred. We will
            make every reasonable effort to address your concerns and provide a
            prompt resolution.
          </p>

          <p className="text-lg font-darker-grotesque">Third-Party Content</p>
          <p className="font-darker-grotesque text-lg mb-8">
            While we strive to ensure accessibility across our site, some
            content provided by third parties, such as embedded videos or
            external links, may not be fully compliant with our accessibility
            standards. We will work with these parties to encourage adherence to
            WCAG guidelines whenever possible.
          </p>
