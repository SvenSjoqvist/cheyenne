        ...
        {faqItems.map((item, index) => (
          <div key={index} className="border-b border-gray-300">
            <button
              ...
              className="w-full flex justify-between items-center text-left py-3 sm:py-4 text-xs sm:text-sm font-medium hover:text-black"
            >
            ...
            {openIndex === index && (
              <div className="pb-3 sm:pb-4 text-xs sm:text-sm text-gray-700">
                <p>{item.answer}</p>
              </div>
            )}
          </div>
