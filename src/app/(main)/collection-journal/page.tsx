...
export default async function CollectionJournalPage() {
    ...
    <div className="">
        <h1 className="text-3xl md:text-4xl lg:text-5xl font-bold text-center font-[bero] mt-10 md:mt-20">
            the runaway collection: <br />a journey of self-discovery
        </h1>
        ...
        <div className="flex justify-center items-center mt-8 md:mt-10 flex-col px-4">
          <p className="text-center text-lg md:text-xl lg:text-2xl font-light font-darker-grotesque max-w-[960px] italic">
            "Working on the first collection was an experience to remember. Connecting with our closest friends who believe in the brand is truly something we appreciate so deeply. Getting together, trying on the bikinis, and creating elaborate sets to take the perfect photos is so core to what this brand stands for—intimacy, intention, and joy. I won't forget the smiles on all of our faces, seeing the vision come to life."
          </p>
          <p className="text-center text-base md:text-lg lg:text-xl font-light font-darker-grotesque mt-4">— Note from the Founders</p>
        </div>
        <div className="flex justify-center items-center mt-8 md:mt-10 bg-[#212121] w-screen min-h-[703px] py-12">
          <h1 className="text-center text-xl md:text-2xl lg:text-3xl font-light text-[#F7F7F7] font-darker-grotesque max-w-[472px] leading-normal">
            Every detail serves a greater purpose: to celebrate the remarkable woman who will wear these pieces.
            We're honored to create swimwear that becomes part of your most treasured experiences, holding within them summer laughter, unexpected connections, and the quiet confidence that comes from knowing you belong exactly where you are.
          </h1>
        </div>
    </div>
  );
