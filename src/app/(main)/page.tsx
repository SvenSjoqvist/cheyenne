...
export async function generateMetadata(): Promise<Metadata> {
  return {
    ...
    description: 'Discover Kilaeko\'s luxury swimwear collection. Sustainable, ethical, and timeless pieces crafted with intention. Shop limited edition swimwear made in Bali. No restocks, limited quantity.',
    keywords: [
      'Kilaeko',
      'luxury swimwear',
  ...
  try {
    ...
    const structuredData = {
      ...
      mainEntity: {
        ...
        description: 'Luxury swimwear collection featuring sustainable and ethical pieces made in Bali',
        url: 'https://kilaeko.com',
        hasPart: productGroups.map((group) => ({
          ...
          offers: {
            ...
            priceCurrency: group.main.priceRange?.minVariantPrice?.currencyCode || 'USD',
            availability: group.main.availableForSale ? 'https://schema.org/InStock' : 'https://schema.org/OutOfStock',
            seller: {
              '@type': 'Organization',
              name: 'Kilaeko'
            }
