...
const ProductSection = ({
  ...
  return (
    <section className="self-center mt-32 w-full max-md:mt-10 max-md:max-w-full">
      <div className="grid grid-cols-1 max-w-[325px] mx-auto min-[1342px]:grid-cols-4 min-[1342px]:max-w-none min-[672px]:grid-cols-2 min-[672px]:max-w-[682px] gap-8 justify-items-center">
        {productGroups.map((group, index) => (
          <article key={index} className="flex flex-col">
            <div className="flex flex-col text-xl font-medium tracking-wider leading-none text-neutral-800 w-[325px]">
              ...
              <h2 className="self-center mt-6 font-darker-grotesque text-center text-2xl">
                {getCleanTitle(group.main.title)}
              </h2>

              <div className="flex justify-between items-center mt-6">
                <p className="font-darker-grotesque min-w-[140px] text-lg">
                  {group.main.title.includes("One Piece") ? "One Piece" : "Top"}
                  : {formatPrice(group.main.priceRange.minVariantPrice.amount)}
                </p>
                  ...
                  {group.related.map((relatedProduct) => (
                    ...
                    >
                      ...
                      <div className="flex flex-col">
                        <button
                          onClick={() =>
                            router.push(`/catalog/${relatedProduct.handle}`)
                          }
                          className="cursor-pointer font-darker-grotesque text-xl whitespace-nowrap"
                        >
                          add to bag
